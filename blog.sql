...
ALTER TABLE board_master add constraint board_master_mem_no_fk foreign key(mem_no)
REFERENCES member(mem_no);

alter table friend add constraint friend_mem_no_fk foreign key(mem_no)
REFERENCES member(mem_no);
